...
- Просмотр откликов студентов (обезличено - курс, направление, количество навыков)
- Запрос выгрузки данных студентов (полные данные через куратора)
...
### Развёртывание на Render.com (Рекомендуется)

Самый простой способ развернуть приложение - использовать [Render.com](https://render.com):
